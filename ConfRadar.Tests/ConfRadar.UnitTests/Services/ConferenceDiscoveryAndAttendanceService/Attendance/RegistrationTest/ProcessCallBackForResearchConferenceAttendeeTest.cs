...
{
    public class ProcessCallBackForResearchConferenceAttendeeTest
    {
        ...
        public ProcessCallBackForResearchConferenceAttendeeTest()
        {
        ...
        public async Task ShouldThrow_WhenTransactionNotInRedis()
        {
            ...
            await Assert.ThrowsAsync<BadRequestException>(() =>
                _service.ProcessCallBackForResearchConferenceAttendee("order1", 100000, "trans1", false));
        }
        ...
        public async Task ShouldThrow_WhenWalletNotFound()
        {
            ...
            await Assert.ThrowsAsync<NotFoundException>(() =>
                _service.ProcessCallBackForResearchConferenceAttendee("order1", 100000, "trans1", true));
        }
